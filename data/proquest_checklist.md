...
**Filtering applied:**
- Searches covering fewer than 3 markets excluded
- Single-keyword broad terms excluded (Russia, Iran, Israel, Trump etc.)
- 3-keyword searches collapsed to 2-keyword parent where parent already exists

**How to download:**
1. ProQuest via UCD library → Advanced Search
2. Source type: Trade Journals | Publication: Financial Times
3. Date range as specified | If >1,000 results → split by year
4. Export: Full Text, Plain Text (.txt)
5. Save to `data/raw/proquest/{folder}/`

---

- [x] `iran_israel` — "Iran" AND "Israel" | 107 markets | 2024-05-02 → 2025-10-31
- [x] `israel_yemen` — "Israel" AND "Yemen" | 90 markets | 2024-08-17 → 2025-10-31
- [x] `iran_usa` — "Iran" AND "USA" | 61 markets | 2024-07-06 → 2025-10-31
- [x] `putin_trump` — "Putin" AND "Trump" | 51 markets | 2024-11-20 → 2025-10-31
- [x] `trump_zelenskyy` — "Trump" AND "Zelenskyy" | 47 markets | 2024-08-20 → 2025-10-31
- [x] `hamas_israel` — "Hamas" AND "Israel" | 45 markets | 2024-06-12 → 2025-10-31
- [x] `gaza_israel` — "Gaza" AND "Israel" | 41 markets | 2024-05-01 → 2025-10-31
- [x] `russia_ukraine` — "Russia" AND "Ukraine" | 36 markets | 2024-08-17 → 2025-10-31
- [x] `putin_zelenskyy` — "Putin" AND "Zelenskyy" | 35 markets | 2025-03-19 → 2025-10-31
- [x] `israel_syria` — "Israel" AND "Syria" | 29 markets | 2024-08-14 → 2025-10-31
- [x] `india_pakistan` — "India" AND "Pakistan" | 28 markets | 2025-03-23 → 2025-10-31
- [x] `zelenskyy` — "Zelenskyy" | 21 markets | 2024-12-24 → 2025-10-31
- [x] `trump_ukraine` — "Trump" AND "Ukraine" | 21 markets | 2024-09-22 → 2025-06-30 - covered in trump_zelenskyy
- [x] `house_of_councillors_japan` — "House of Councillors" AND "Japan" | 21 markets | 2025-05-11 → 2025-07-27
- [x] `starmer_trump` — "Starmer" AND "Trump" | 20 markets | 2025-01-27 → 2025-02-27
- [x] `south_korea_trump` — "South Korea" AND "Trump" | 19 markets | 2025-04-22 → 2025-10-31
- [x] `merz_trump` — "Merz" AND "Trump" | 18 markets | 2025-05-03 → 2025-06-05
- [x] `netanyahu` — "Netanyahu" | 18 markets | 2024-09-25 → 2025-10-31
- [x] `trump_turkey` — "Trump" AND "Turkey" | 18 markets | 2025-02-19 → 2025-09-25
- [x] `netanyahu_un_general_assembly` — "Netanyahu" AND "UN General Assembly" | 17 markets | 2025-08-24 → 2025-09-26
- [x] `trump_un_general_assembly` — "Trump" AND "UN General Assembly" | 17 markets | 2025-08-10 → 2025-09-23
- [x] `north_korea` — "North Korea" | 16 markets | 2024-12-01 → 2025-10-15
- [x] `gulf_leaders_summit_trump` — "Gulf Leaders Summit" AND "Trump" | 16 markets | 2025-04-12 → 2025-05-14
- [x] `macron_trump` — "Macron" AND "Trump" | 15 markets | 2025-01-25 → 2025-10-31
- [x] `israel_lebanon` — "Israel" AND "Lebanon" | 14 markets | 2024-05-11 → 2025-10-31

- [ ] `uk_usa` — "UK" AND "USA" | 14 markets | 2025-01-28 → 2025-10-31 ( too big )
- [x] `poland_trump` — "Poland" AND "Trump" | 14 markets | 2025-07-27 → 2025-09-03
- [x] `saudi_arabia_usa` — "Saudi Arabia" AND "USA" | 14 markets | 2025-04-10 → 2025-10-31
...
- [ ] `putin_russia` — "Putin" AND "Russia" | 6 markets | 2024-02-25 → 2025-10-31
- [ ] `nato_ukraine` — "NATO" AND "Ukraine" | 6 markets | 2024-03-05 → 2025-10-31
...
- [x] `russia_sudzha` — "Russia" AND "Sudzha" | 5 markets | 2024-09-17 → 2025-07-31
- [x] `syria` — "Syria" | 5 markets | 2024-11-10 → 2025-09-30
...
- [x] `jerome_powell` — "Jerome Powell" | 5 markets | 2025-07-02 → 2025-10-31
- [ ] `rodynske_russia` — "Rodynske" AND "Russia" | 5 markets | 2025-06-22 → 2025-10-31
- [x] `usa_ukraine` — "USA" AND "Ukraine" | 5 markets | 2025-01-21 → 2025-10-31 - covered in trump_zelenskyy





- [ ] `macron` — "Macron" | 4 markets | 2024-07-28 → 2025-10-31
- [ ] `milei` — "Milei" | 4 markets | 2025-01-11 → 2025-10-31
- [ ] `brazil` — "Brazil" | 4 markets | 2024-07-30 → 2025-07-31 ( maybe lula)
- [ ] `canada_trump` — "Canada" AND "Trump" | 4 markets | 2025-01-27 → 2025-10-31
- [ ] `france_trump` — "France" AND "Trump" | 4 markets | 2025-07-02 → 2025-10-31
- [ ] `eu_russia` — "EU" AND "Russia" | 4 markets | 2025-04-14 → 2025-10-31
- [ ] `elon_musk` — "Elon Musk" | 4 markets | 2025-06-08 → 2025-10-31
- [ ] `novopavlivka_russia` — "Novopavlivka" AND "Russia" | 4 markets | 2025-06-22 → 2025-10-31
- [ ] `poland_russia` — "Poland" AND "Russia" | 4 markets | 2025-08-10 → 2025-09-30
- [ ] `von_der_leyen` — "Von der Leyen" | 4 markets | 2025-06-08 → 2025-10-31
- [ ] `israel_turkey` — "Israel" AND "Turkey" | 4 markets | 2024-06-29 → 2025-10-31
- [ ] `israel_qatar` — "Israel" AND "Qatar" | 4 markets | 2025-08-05 → 2025-10-31
...
- [ ] `cambodia_thailand` — "Cambodia" AND "Thailand" | 4 markets | 2025-06-24 → 2025-08-31
- [ ] `donbas` — "Donbas" | 4 markets | 2025-07-13 → 2025-10-31
- [ ] `dobropillia_russia` — "Dobropillia" AND "Russia" | 4 markets | 2025-07-12 → 2025-10-31
- [ ] `israel_usa` — "Israel" AND "USA" | 4 markets | 2025-06-25 → 2025-10-31
- [ ] `switzerland_trump` — "Switzerland" AND "Trump" | 3 markets | 2025-07-05 → 2025-10-31
- [ ] `mexico_trump` — "Mexico" AND "Trump" | 3 markets | 2025-07-02 → 2025-10-31
- [x] `israel_saudi_arabia` — "Israel" AND "Saudi Arabia" | 3 markets | 2024-11-17 → 2025-10-31
- [ ] `nato_usa` — "NATO" AND "USA" | 3 markets | 2024-11-29 → 2025-10-31
- [x] `al-sharaa_netanyahu` — "Al-Sharaa" AND "Netanyahu" | 3 markets | 2025-05-31 → 2025-10-31
- [ ] `australia_trump` — "Australia" AND "Trump" | 3 markets | 2025-07-02 → 2025-10-31
...
- [ ] `apple_trump` — "Apple" AND "Trump" | 3 markets | 2025-02-26 → 2025-04-02

*132 searches | 1801 total markets*